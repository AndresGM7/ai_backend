...
Backend en FastAPI para análisis y optimización de precios usando elasticidad, sesiones en Redis, streaming y pruebas automatizadas. Incluye cálculo de elasticidad propia y cruzada, recomendación de precio óptimo y carga de datos CSV (dataset base estilo Kaggle) para generar series de precio-cantidad por categoría.
